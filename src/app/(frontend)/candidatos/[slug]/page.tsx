    ...
    <section>
      ...
      <div className="mb-6 md:hidden">
        <div className="flex gap-4">
          {/* Small square photo */}
          <div className="relative aspect-square w-28 shrink-0 overflow-hidden rounded-lg bg-secondary">
            {imageUrl ? (
              <Image
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center">
            <h1 className="text-xl leading-tight">{candidate.name}</h1>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Actualizado: {formatDate(candidate.lastUpdated)}
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 flex gap-2">
          <Button asChild variant="outline" className="flex-1" size="sm">
            <Link href={`/comparar?a=${candidate.slug}`}>Comparar</Link>
          </Button>
          <Button asChild variant="outline" className="flex-1" size="sm">
      ...
      <div className="grid gap-8 md:grid-cols-[minmax(260px,30%)_1fr]">
        ...
        <StickySidebar className="hidden md:block">
